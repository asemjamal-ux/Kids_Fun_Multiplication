...
(function () {
  ...
  T.en = {
    ...
    'prizes.stickers.h3': '✨ Stickers', 'prizes.trophies.h3': '🏆 Trophies',
    'prizes.trophies.lead': 'Trophies are earned by doing something special. The 🔥 ones only open once you really know the hard tables (6, 7, 8 and 9): at least 15 answers on that table with 9 out of 10 correct.',
    'prizes.hard': '🔥 Hard tables',
    'badge.bingo': 'Bingo Champion', 'badge.bingo.how': 'Win a game of Multiplication Bingo.',
    'badge.memory': 'Memory Whiz', 'badge.memory.how': 'Finish Memory Match in 12 moves or fewer.',
    'badge.racer': 'Speed Rocket', 'badge.racer.how': 'Score 20 or more in Times Table Race.',
    ...
    'badge.little': 'Little Tables Star', 'badge.little.how': 'Master the 1, 2, 3, 4 and 5 times tables.',
    'badge.t6': 'Busy Bee', 'badge.t6.how': 'Master the 6 times table.',
    'badge.t7': 'Rainbow Wizard', 'badge.t7.how': 'Master the 7 times table.',
    'badge.t8': 'Octopus Captain', 'badge.t8.how': 'Master the 8 times table.',
    'badge.t9': 'Nine Ninja', 'badge.t9.how': 'Master the 9 times table.',
    'badge.hardracer': 'Fire Racer', 'badge.hardracer.how': 'Score 15+ in the Race using only tables 6–9.',
    'badge.hardpop': 'Hot Popper', 'badge.hardpop.how': 'Pop 10 balloons using only tables 6–9.',
    'badge.hero': 'Hard Table Hero', 'badge.hero.how': 'Master all four hard tables: 6, 7, 8 and 9.',
    'badge.royalty': 'Multiplication Royalty', 'badge.royalty.how': 'Master every table from 1 to 10.',
    'badge.genius': 'Multiplication Genius', 'badge.genius.how': 'Collect 500 stars.',
    'sticker.24': 'Whale', 'sticker.25': 'Volcano', 'sticker.26': 'Flamingo', 'sticker.27': 'Circus', 'sticker.28': 'Watermelon', 'sticker.29': 'Koala',
    'sticker.30': 'Helicopter', 'sticker.31': 'Mermaid', 'sticker.32': 'Peacock', 'sticker.33': 'Strawberry', 'sticker.34': 'Moon', 'sticker.35': 'Shark',
  };

  /* ---------- Arabic ---------- */
  T.ar = {
    /* Trophies */
    'badge.title': '🏆 كأس لـ{name}!', 'badge.titleAnon': '🏆 لقد ربحت كأساً!',
    'badge.body': 'لقد فتحت: {badge}',
    'prizes.stickers.h3': '✨ الملصقات', 'prizes.trophies.h3': '🏆 الكؤوس',
    'prizes.trophies.lead': 'تُكسب الكؤوس بفعل شيء مميز. الكؤوس التي تحمل 🔥 لا تُفتح إلا بعد إتقان الجداول الصعبة (6 و7 و8 و9): 15 إجابة على الأقل في ذلك الجدول مع 9 صحيحة من كل 10.',
    'prizes.hard': '🔥 الجداول الصعبة',
    'badge.bingo': 'بطل البينغو', 'badge.bingo.how': 'افز بلعبة بينغو الضرب.',
    'badge.memory': 'عبقري الذاكرة', 'badge.memory.how': 'أكمل لعبة الذاكرة في 12 محاولة أو أقل.',
    'badge.racer': 'صاروخ السرعة', 'badge.racer.how': 'أحرز 20 نقطة أو أكثر في سباق جدول الضرب.',
    ...
    'badge.little': 'نجم الجداول الصغيرة', 'badge.little.how': 'أتقن جداول 1 و2 و3 و4 و5.',
    'badge.t6': 'النحلة النشيطة', 'badge.t6.how': 'أتقن جدول 6.',
    'badge.t7': 'ساحر قوس قزح', 'badge.t7.how': 'أتقن جدول 7.',
    'badge.t8': 'قبطان الأخطبوط', 'badge.t8.how': 'أتقن جدول 8.',
    'badge.t9': 'نينجا التسعة', 'badge.t9.how': 'أتقن جدول 9.',
    'badge.hardracer': 'متسابق النار', 'badge.hardracer.how': 'أحرز 15+ في السباق باستخدام الجداول 6–9 فقط.',
    'badge.hardpop': 'الفرقعة الحارة', 'badge.hardpop.how': 'فرقع 10 بالونات باستخدام الجداول 6–9 فقط.',
    'badge.hero': 'بطل الجداول الصعبة', 'badge.hero.how': 'أتقن الجداول الصعبة الأربعة: 6 و7 و8 و9.',
    'badge.royalty': 'ملك الضرب', 'badge.royalty.how': 'أتقن كل الجداول من 1 إلى 10.',
    'badge.genius': 'عبقري الضرب', 'badge.genius.how': 'اجمع 500 نجمة.',
    'sticker.24': 'حوت', 'sticker.25': 'بركان', 'sticker.26': 'فلامنغو', 'sticker.27': 'سيرك', 'sticker.28': 'بطيخ', 'sticker.29': 'كوالا',
    'sticker.30': 'مروحية', 'sticker.31': 'حورية البحر', 'sticker.32': 'طاووس', 'sticker.33': 'فراولة', 'sticker.34': 'قمر', 'sticker.35': 'قرش',
    /* Player name & prizes */
